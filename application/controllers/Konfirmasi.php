...
class Konfirmasi extends CI_Controller
{
	...
	function tambah_aksi()
	{
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('Welcome/Produk_member'); //jika berhasil maka akan ditampilkan view upload
            }else{
	...
	public function download($id){
        if(!empty($id)){
            ...
            $this->session->set_flashdata("pesan", "<div class=\"col-md-12\"><div class=\"alert alert-danger\" id=\"alert\">Gambar Berhasil di Download!!</div></div>");
